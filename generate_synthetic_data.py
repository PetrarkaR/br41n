...
# Load data
#mat = loadmat("magic/P1_high1_clean_with_ICA.mat", struct_as_record=False, squeeze_me=False)
#mat1 = loadmat("magic/P1_high2_clean_with_ICA.mat", struct_as_record=False, squeeze_me=False)
mat1 = loadmat("sophie/P2_high1_clean_with_ICA.mat", struct_as_record=False, squeeze_me=False)
mat = loadmat("sophie/P2_high2_clean_with_ICA.mat", struct_as_record=False, squeeze_me=False)
keys = list(mat.keys())
print("MAT keys:", keys)
X = get_field_from_struct(mat, ['X', 'x', 'y', 'signal', 'EEG', 'data','epochs_cleaned'])
X1 = get_field_from_struct(mat1, ['X', 'x', 'y', 'signal', 'EEG', 'data','epochs_cleaned'])
#X2 = get_field_from_struct(mat2, ['X', 'x', 'y', 'signal', 'EEG', 'data','epochs_cleaned'])
#X3 = get_field_from_struct(mat3, ['X', 'x', 'y', 'signal', 'EEG', 'data','epochs_cleaned'])
fs = 256
...
#n_steps_x2 = X2.shape[0]
#n_steps_x3 = X3.shape[0]
...
class1_eeg = X[:n_steps, :].T  # Transpose! Shape becomes (8, n_samples)
class2_eeg = X1[:n_steps, :].T  # Transpose! Shape becomes (8, n_samples)
...
noise_neurons = np.array([100,200,250,300])
noise_factor = np.array([1,10,20,30,40,50])
